...
## Вариант 5: WSL в VS Code (Windows 11)
1. Установите WSL и расширение **WSL** для VS Code (если ещё нет).
2. В VS Code: `Ctrl+Shift+P` → **WSL: Open Folder in WSL** → откройте папку с проектом.
3. Откройте терминал (Ctrl+`) — он должен быть `WSL: Ubuntu`, а не PowerShell.
4. Выполните:
   ```bash
...
6. Импортируйте `.conf` в AmneziaVPN.
